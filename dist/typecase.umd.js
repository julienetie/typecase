...
var main = function main(typeIf) {
    return function () {
        ...
        if (typeOfValue === 'number') {
            ...
            return typeIf ? { number: value } : assign(numberWrapper);
        }
        ...
        if (typeOfValue !== 'object') {
            ...
            var _wrapper = {};
            _wrapper[typeOfValue] = value;
            return typeIf ? _wrapper : assign(commonTypes);
        }
        ...
        if (value === null) {
            ...
            return typeIf ? { null: value } : assign(valueType);
        }
        ...
        if (Array.isArray(value)) {
            ...
            return typeIf ? { array: value } : assign(arrayWrapper);
        }
        ...
        if (objectType === 'objectRegExp') {
            ...
            return typeIf ? { regExp: value } : assign(objectWrapper);
        }
        ...
        return typeIf ? wrapper : assign(objectWrapper);
    };
};

var typeIf = function typeIf() {
    return main(true).apply(undefined, arguments);
};
var type = function type() {
    return main(false).apply(undefined, arguments);
};

// Attach typeIf as a method.
type.if = typeIf;
